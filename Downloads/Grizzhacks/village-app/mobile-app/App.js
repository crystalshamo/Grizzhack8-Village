...
const s = StyleSheet.create({
  ...
  hamburger: { width: 40, height: 40, borderRadius: 10, justifyContent: 'center', alignItems: 'center' },
  ...
  notifItem: { paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#F0F0F6' },
  ...
  hamLine: { width: 20, height: 2, backgroundColor: '#1A1A2E', borderRadius: 2, marginVertical: 2 },

  drawerModal:   { flex: 1, flexDirection: 'row' },
  drawerBackdrop: { flex: 1, backgroundColor: 'rgba(20,18,30,0.4)' },
  drawer: {
    position: 'absolute', top: 0, left: 0, bottom: 0, width: 280,
    backgroundColor: '#ffffff', borderTopRightRadius: 28, borderBottomRightRadius: 28,
    ...Platform.select({
  ...
  drawerTop: {
    ...
    borderBottomWidth: 1, borderBottomColor: '#F0F0F6',
  },
  drawerLogo:      { fontSize: 22, fontWeight: '800', color: '#1A1A2E' },
  drawerCloseBtn:  { padding: 6, borderRadius: 8 },
  drawerCloseText: { fontSize: 16, color: '#8B8FA8' },
  drawerNav:       { padding: 12, flex: 1 },
  drawerItem: {
    flexDirection: 'row', alignItems: 'center', gap: 14,
    paddingVertical: 13, paddingHorizontal: 16, borderRadius: 16, marginBottom: 4,
  },
  ...
  fab: {
    position: 'absolute', bottom: 30, right: 22, width: 56, height: 56,
    borderRadius: 28, backgroundColor: '#1A1A2E', justifyContent: 'center', alignItems: 'center',
    ...Platform.select({
