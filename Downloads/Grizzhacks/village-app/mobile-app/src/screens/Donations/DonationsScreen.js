...
const handleContribute = async () => {
 ...
 try {
   const res = await fetch(`${API_URL}/api/donations/${item.donation_id}/contribute`, {
     ...
     body: JSON.stringify({ amount: val, contributor_id: currentUserId }),
   })
...
tabText: { fontFamily: fonts.regular, fontSize: 13, color: colors.lightpurple },
tabTextActive: { fontFamily: fonts.bold, color: colors.purple },
...
browseFilterScroll: { marginBottom: 6 },
reviewFilterScroll: { marginBottom: 8 },
...
pillText: { color: colors.lightpurple, fontFamily: fonts.regular, fontSize: 12 },
pillTextActive: { color: colors.purple, fontFamily: fonts.bold },
urgentPill: {
 marginTop: 2,
 marginBottom: 8,
 paddingVertical: 8,
...
trendingSection: { marginTop: 0, marginBottom: 8 },
